	...
	<div class="modal-dialog" role="document">
		<div class="modal-content ">
			<div class="modal-header bg-light">
				<h4 class="modal-title"><b id="leave_types_title"></b></h4>
			</div>
			<div class="modal-body">

				<input type="hidden" id="leave_types_type">
				<input type="hidden" id="leave_types_id">
				<input type="hidden" id="leave_types_order_old">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="form-group">
							<label><span class="badge badge-secondary ">4</span> กลุ่ม </label>
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="leave_types_order_new"
								placeholder="กรุณากรอกข้อมูล ">
						</div>
					</div>
				</div>
