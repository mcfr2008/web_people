	...
	<div class="modal-dialog" role="document">
		<div class="modal-content ">
			<div class="modal-header bg-light">
				<h4 class="modal-title"><b id="departments_title"></b></h4>
			</div>
			<div class="modal-body">

				<input type="hidden" id="departments_type">
				<input type="hidden" id="departments_id">
				<input type="hidden" id="departments_order_old">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="form-group">
							<label><span class="badge badge-secondary ">4</span> กำหนดลำดับ </label>
							<input type="text" class="form-control" id="departments_order_new"
								placeholder="กรุณากรอกข้อมูล ">
						</div>
					</div>
				</div>
