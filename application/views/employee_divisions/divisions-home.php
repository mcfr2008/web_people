...
<section class="content">
	<div class="container-fluid">
		...
		<div class="row ">
			...
			<div class="col-md-3">
				<div class="form-group">
					<select class="form-control" id="search_department"></select>
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-group">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content ">
			<div class="modal-header bg-light">
				<h4 class="modal-title"><b id="divisions_title"></b></h4>
			</div>
			<div class="modal-body">

				<input type="hidden" id="divisions_type">
				<input type="hidden" id="divisions_id">
				<input type="hidden" id="divisions_order_old">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="form-group">
							<label><span class="badge badge-secondary ">4</span> กำหนดฝ่าย </label>
							<select class="form-control" id="department_id"></select>
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<label><span class="badge badge-secondary ">5</span> กำหนดลำดับ </label>
							<input type="text" class="form-control" id="divisions_order_new"
								placeholder="กรุณากรอกข้อมูล ">
						</div>
					</div>
				</div>
