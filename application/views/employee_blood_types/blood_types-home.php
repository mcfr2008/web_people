	...
	<div class="modal-dialog" role="document">
		<div class="modal-content ">
			<div class="modal-header bg-light">
				<h4 class="modal-title"><b id="blood_types_title"></b></h4>
			</div>
			<div class="modal-body">

				<input type="hidden" id="blood_types_type">
				<input type="hidden" id="blood_types_id">
