	...
	<div class="modal-dialog" role="document">
		<div class="modal-content ">
			<div class="modal-header bg-light">
				<h4 class="modal-title"><b id="application_title"></b></h4>
			</div>
			<div class="modal-body">

				<input type="hidden" id="application_type">
				<input type="hidden" id="application_id">

				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<label><span class="badge badge-secondary ">1</span> Application name </label>
					...
					<div class="col-md-12">
						<div class="form-group">
							<label><span class="badge badge-secondary ">2</span> Title </label>
					...
					<div class="col-md-12">
						<div class="form-group">
							<label><span class="badge badge-secondary ">3</span> Icon </label>
							<input type="text" class="form-control" id="icon"
								placeholder="Please fill in your information ">
							<small class="help-block"> Select more icons at : <a
									href="https://fortawesome.github.io/Font-Awesome/icons/">fortawesome</a> </small>
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<label><span class="badge badge-secondary ">4</span> URL </label>
					...
					<div class="col-md-12">
						<div class="form-group">
							<label><span class="badge badge-secondary ">5</span> Detail </label>
								<textarea  class="form-control" id="detail"
								placeholder="Please fill in your information"  rows="3"></textarea>
						</div>
					</div>
				</div>
			</div>
			<div class="modal-footer bg-light">
				<button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="javascript:clear_data_manage()"><i class="fas fa-sign-out-alt"></i>
					Close</button>
