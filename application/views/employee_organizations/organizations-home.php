	...
	<div class="modal-dialog" role="document">
		<div class="modal-content ">
			<div class="modal-header bg-light">
				<h4 class="modal-title"><b id="organizations_title"></b></h4>
			</div>
			<div class="modal-body">

				<input type="hidden" id="organizations_type">
				<input type="hidden" id="organizations_id">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="form-group">
							<label><span class="badge badge-secondary ">2</span> ที่อยู่(ภาษาไทย) </label>
							<textarea class="form-control" id="address_th" rows="4"
								placeholder="กรุณากรอกข้อมูล"></textarea>
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<label><span class="badge badge-secondary ">3</span> ชื่อ(ภาษาอังกฤษ) </label>
					...
					<div class="col-md-12">
						<div class="form-group">
							<label><span class="badge badge-secondary ">4</span> ที่อยู่(ภาษาอังกฤษ) </label>
							<textarea class="form-control" id="address_en" rows="4"
								placeholder="กรุณากรอกข้อมูล"></textarea>
						</div>
					</div>
