...
<section class="content">
	<div class="container-fluid">
		...
		<div class="row ">
			...
			<div class="col-md-3">
				<div class="form-group">
					<select class="form-control" id="search_organization"></select>
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-group">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content ">
			<div class="modal-header bg-light">
				<h4 class="modal-title"><b id="holiday_dates_title"></b></h4>
			</div>
			<div class="modal-body">

				<input type="hidden" id="holiday_dates_type">
				<input type="hidden" id="holiday_dates_id">
				<!-- <input type="hidden" id="holiday_dates_order_old"> -->
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="form-group">
							<label><span class="badge badge-secondary ">3</span> วันหยุด </label>
					...
					<div class="col-md-12">
						<div class="form-group">
							<label><span class="badge badge-secondary ">4</span> หยุด/ไม่หยุด </label>
							<select class="form-control" id="type_stop_working"></select>
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<label><span class="badge badge-secondary ">5</span> รายละเอียด </label>
					...
					<div class="col-md-12">
						<div class="form-group">
							<label><span class="badge badge-secondary ">6</span> กำหนดองค์กร </label>
							<select class="form-control" id="organization_id"></select>
						</div>
					</div>
