				...
				<div class="card card-secondary shadow ">
					...
					<div class="card-body p-0 table-responsive " style="white-space: normal;">
						...
						<table class="table table-hover " show-filter="true">
							...
							<tbody id="data_driving_license_type">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content ">
			<div class="modal-header bg-light">
				<h4 class="modal-title"><b id="driving_license_type_title"></b></h4>
			</div>
			<div class="modal-body">

				<input type="hidden" id="driving_license_type_type">
				<input type="hidden" id="driving_license_type_id">
